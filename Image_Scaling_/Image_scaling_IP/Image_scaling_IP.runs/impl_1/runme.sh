...
HD_PWD='C:/Users/katku/OneDrive/Desktop/Image_Scaling_FPGA/Image_scaling_IP/Image_scaling_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_scale_ip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source image_scale_ip.tcl -notrace
