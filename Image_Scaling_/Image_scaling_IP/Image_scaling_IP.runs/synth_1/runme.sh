...
HD_PWD='C:/Users/katku/OneDrive/Desktop/Image_Scaling_FPGA/Image_scaling_IP/Image_scaling_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_scale_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_scale_ip.tcl
